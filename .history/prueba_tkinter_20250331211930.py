...
def crear_ventana_consulta(titulo="Consulta", ancho=600, alto=700):
    ...
    # Cargar imagen de fondo para la ventana
    imagen_fondo = cargar_imagen_fondo(ancho, alto)
    label_fondo = tk.Label(ventana, image=imagen_fondo)
    label_fondo.place(x=0, y=0, relwidth=1, relheight=1)
    # Es importante guardar la referencia para evitar que se elimine la imagen
    ventana.imagen_fondo = imagen_fondo

    # Crear un frame central con formato consistente
...
def registrar_cliente_gui():
    ...
    tk.Label(frame, text="Registrar Cliente", font=("Century Gothic", 16, "bold"), fg="white", bg="#053A20").pack(pady=10)
    
    labels = ["Nombre:", "Apellido:", "Teléfono:", "Correo:", "Membresía:"]
    entries = {}
    for campo in labels:
        tk.Label(frame, text=campo, font=("Century Gothic", 12, "bold"), fg="white", bg="#053A20").pack(pady=2)
    ...
    tk.Button(frame, text="Guardar", font=("Century Gothic", 12, "bold"), bg="#157347", fg="white", command=guardar_cliente).pack(pady=10)

def registrar_producto_gui():
    ventana, frame = crear_ventana_consulta("Registrar Producto", 600, 700)
    
    tk.Label(frame, text="Registrar Producto", font=("Century Gothic", 16, "bold"), fg="white", bg="#053A20").pack(pady=10)
    
    tk.Label(frame, text="Nombre del Producto:", font=("Century Gothic", 12, "bold"), fg="white", bg="#053A20").pack(pady=5)
    entry_nombre = tk.Entry(frame, font=("Century Gothic", 12))
    entry_nombre.pack(pady=5)
    
    tk.Label(frame, text="Precio Unitario:", font=("Century Gothic", 12, "bold"), fg="white", bg="#053A20").pack(pady=5)
    ...
    tk.Button(frame, text="Guardar", font=("Century Gothic", 12, "bold"), bg="#157347", fg="white", command=guardar_producto).pack(pady=10)

def realizar_compra_gui():
    ventana, frame = crear_ventana_consulta("Realizar Compra", 600, 700)
    
    tk.Label(frame, text="Realizar Compra", font=("Century Gothic", 16, "bold"), fg="white", bg="#053A20").pack(pady=10)
    
    tk.Label(frame, text="Correo del Cliente:", font=("Century Gothic", 12, "bold"), fg="white", bg="#053A20").pack(pady=5)
    entry_correo = tk.Entry(frame, font=("Century Gothic", 12))
    entry_correo.pack(pady=5)
    
    tk.Label(frame, text="Forma de Pago:", font=("Century Gothic", 12, "bold"), fg="white", bg="#053A20").pack(pady=5)
    ...
    # Se crea un frame interno para los datos de producto
    frame_producto = tk.Frame(frame, bg="#053A20")
    frame_producto.pack(pady=10)
    
    tk.Label(frame_producto, text="ID Producto:", font=("Century Gothic", 12, "bold"), fg="white", bg="#053A20").grid(row=0, column=0, padx=5, pady=2)
    entry_id_producto = tk.Entry(frame_producto, font=("Century Gothic", 12))
    entry_id_producto.grid(row=0, column=1, padx=5, pady=2)
    
    tk.Label(frame_producto, text="Cantidad:", font=("Century Gothic", 12, "bold"), fg="white", bg="#053A20").grid(row=1, column=0, padx=5, pady=2)
    entry_cantidad = tk.Entry(frame_producto, font=("Century Gothic", 12))
    entry_cantidad.grid(row=1, column=1, padx=5, pady=2)
    
    tk.Label(frame_producto, text="Precio Unitario:", font=("Century Gothic", 12, "bold"), fg="white", bg="#053A20").grid(row=2, column=0, padx=5, pady=2)
    ...
    tk.Button(frame_producto, text="Agregar Producto", font=("Century Gothic", 12, "bold"), bg="#157347", fg="white", command=agregar_producto).grid(row=3, column=0, columnspan=2, pady=10)
    ...
    tk.Button(frame, text="Finalizar Compra", font=("Century Gothic", 12, "bold"), bg="#157347", fg="white", command=finalizar_compra).pack(pady=10)

def ver_info_cliente_gui():
    ventana, frame = crear_ventana_consulta("Ver Información del Cliente", 600, 700)
    
    tk.Label(frame, text="Ver Información del Cliente", font=("Century Gothic", 16, "bold"), fg="white", bg="#053A20").pack(pady=10)
    ...
    tk.Button(frame, text="Buscar", font=("Century Gothic", 12, "bold"), bg="#157347", fg="white", command=buscar_cliente).pack(pady=5)

def ver_compras_cliente_gui():
    ventana, frame = crear_ventana_consulta("Ver Compras del Cliente", 600, 700)
    
    tk.Label(frame, text="Ver Compras del Cliente", font=("Century Gothic", 16, "bold"), fg="white", bg="#053A20").pack(pady=10)
    ...
    tk.Button(frame, text="Buscar Compras", font=("Century Gothic", 12, "bold"), bg="#157347", fg="white", command=buscar_compras).pack(pady=5)

def sumar_valor_compras_gui():
    ventana, frame = crear_ventana_consulta("Sumar Valor de Compras", 600, 700)
    
    tk.Label(frame, text="Sumar Valor de Compras", font=("Century Gothic", 16, "bold"), fg="white", bg="#053A20").pack(pady=10)
    
    tk.Label(frame, text="Correo del Cliente:", font=("Century Gothic", 12, "bold"), fg="white", bg="#053A20").pack(pady=5)
    entry_correo = tk.Entry(frame, font=("Century Gothic", 12))
    entry_correo.pack(pady=5)
    
    resultado_label = tk.Label(frame, text="", font=("Century Gothic", 12, "bold"), fg="white", bg="#053A20")
    ...
    tk.Button(frame, text="Sumar Compras", font=("Century Gothic", 12, "bold"), bg="#157347", fg="white", command=sumar_compras).pack(pady=5)

def ordenar_productos_gui():
    ventana, frame = crear_ventana_consulta("Productos Más Vendidos", 600, 700)
    
    tk.Label(frame, text="Productos Más Vendidos", font=("Century Gothic", 16, "bold"), fg="white", bg="#053A20").pack(pady=10)
...
def abrir_panel_consultas():
    ...
    tk.Label(frame_menu, text="Menú de Consultas", font=("Century Gothic", 16, "bold"), fg="white", bg="#053A20").pack(pady=10)
...
tk.Label(frame_login, text="Bienvenido a System_GYM", font=("Century Gothic", 16, "bold"), fg="white", bg="#053A20").pack(pady=10)
tk.Label(frame_login, text="Usuario:", font=("Century Gothic", 14, "bold"), fg="white", bg="#053A20").pack(pady=2)
entrada_usuario = tk.Entry(frame_login, font=("Century Gothic", 12))
entrada_usuario.pack(pady=2)
tk.Label(frame_login, text="Contraseña:", font=("Century Gothic", 14, "bold"), fg="white", bg="#053A20").pack(pady=2)
entrada_contraseña = tk.Entry(frame_login, font=("Century Gothic", 12), show="*")
entrada_contraseña.pack(pady=2)
tk.Button(frame_login, text="Iniciar sesión", font=("Century Gothic", 14, "bold"), bg="#28A745", fg="white", command=validar_login).pack(pady=20)
