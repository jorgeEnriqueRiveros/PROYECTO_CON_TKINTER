...
# Color de fondo más claro para simular transparencia
color_fondo = "#053A20"  # Verde oscuro

# Crear un Frame con fondo más claro para simular transparencia
...
boton_login = tk.Button(frame_transparente, text="Iniciar sesión", font=fuente_texto, bg="#28A745", fg="white", relief="raised", bd=3)
