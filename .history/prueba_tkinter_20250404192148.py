...
def registrar_cliente_gui():
    ...
    def guardar_cliente():
        ...
        if nombre and apellido and telefono and correo and membresia:
            ...
            try:
                cliente.guardar()
                mostrar_mensaje_custom("Éxito", "Cliente registrado correctamente")
                ventana.destroy()
    ...
    def guardar_producto():
        ...
        if nombre:
            ...
            try:
                ...
                mostrar_mensaje_custom("Éxito", "Producto registrado correctamente")
                ventana.destroy()
            except Exception as e:
...
def realizar_compra_gui():
    ...
    # Frame para los botones de agregar y finalizar compra
    ...
    def realizar_busqueda():
        ...
        if resultados:
            for cliente in resultados:
                resultados_text.insert(tk.END, str(cliente) + "\n")
        else:
            resultados_text.insert(tk.END, "No se encontró ningún cliente")
...
def abrir_panel_consultas():
    ...
    botones = [
        ...
        ("Buscar Cliente", buscar_cliente_gui),
    ...
    # Botón para cerrar sesión y volver al login (no cierra el programa completo)
