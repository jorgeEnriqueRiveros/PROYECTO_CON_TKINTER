...
def abrir_panel_consultas():
    ...
    frame_menu.place(relx=0.5, rely=0.5, anchor="center", width=500, height=400)
    
    tk.Label(frame_menu, text="Menú de Consultas", font=("Century Gothic", 16, "bold"),
             fg="white", bg="#053A20").pack(pady=10)
    
    tk.Button(frame_menu, text="Realizar Compra", font=("Century Gothic", 12, "bold"),
              bg="#157347", fg="white", command=realizar_compra_gui).pack(pady=10)
    tk.Button(frame_menu, text="Cerrar Sesión", font=("Century Gothic", 12, "bold"),
              bg="#157347", fg="white", command=lambda: cerrar_sesion(panel)).pack(pady=10)

# ===============================================================
# Código de la ventana de login
# ===============================================================
...
tk.Button(windows, text="Ingresar", font=("Century Gothic", 12, "bold"),
          bg="#157347", fg="white", command=validar_login).pack(pady=10)
